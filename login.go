...
func PostParametersLogin(url, method string, hiddenParams map[string]string, usernameField, usernameValue, passwordField, passwordValue string, Cookies []*http.Cookie) (*http.Response, time.Duration, error) {
